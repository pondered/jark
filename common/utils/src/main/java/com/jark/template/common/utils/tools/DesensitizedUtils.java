...
public final class DesensitizedUtils {
     ...
     * @return 脱敏后结果
     */
    public static String desValue(final String origin, final int prefixNoMaskLen, final int suffixNoMaskLen, final String maskStr) {
        if (origin == null) {
            return null;
        }
    ...
    public static String chineseName(final String fullName) {
        ...
        return desValue(fullName, 0, 1, STRING);
    }
    ...
    public static String fixedPhone(final String num) {
        return desValue(num, 0, 4, STRING);
    }
    ...
    public static String mobilePhone(final String num) {
        return desValue(num, 3, 4, STRING);
    }
    ...
    public static String address(final String address) {
        return desValue(address, 6, 0, STRING);
    }
    ...
    public static String email(final String email) {
        ...
        String preEmail = desValue(email.substring(0, index), 1, 0, STRING);
    ...
    public static String bankCard(final String cardNum) {
        return desValue(cardNum, 6, 4, STRING);
    }
    ...
    public static String key(final String key) {
        ...
        int viewLength = 6;
        StringBuilder tmpKey = new StringBuilder(desValue(key, 0, 3, STRING));
